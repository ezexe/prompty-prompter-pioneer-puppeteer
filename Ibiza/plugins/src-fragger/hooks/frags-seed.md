...
A frag is code whose job no single tool call does; an edit, an append, a whole-file write, or one shell command is the tool's own call and is never registered here.
