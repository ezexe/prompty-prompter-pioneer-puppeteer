...
The operative ledger shapes live in `ledger.md`'s own header (the canonical form); the block below is the teaching copy, and on divergence the file wins — a user's edit to it is a ruling.
