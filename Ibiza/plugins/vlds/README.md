...
The mechanical companion `scripts/phi.py` (check / mask / verify-merge / verify-pour / lock / rebuild / restore / lint) computes and verifies; every judgment about what deserves keeping stays with the gc, in-session.
