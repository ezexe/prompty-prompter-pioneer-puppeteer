...
2. Read each skill's frontmatter `metadata.p4.depends_on` (`skills/*/SKILL.md`) and `docs/fragments.md` for the layer dependencies.
...
**Output:** the selected skills + P4 layers, `dependencies_satisfied` (true/false), and any `missing_dependencies`.
